...
This is an alternative to the pre-sold bluetooth module as our team had issues with it. 


Anyphone or laptop can connect to the Ground Station using the nRF Connect App (or similar bluetooth app)
